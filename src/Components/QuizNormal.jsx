...
export default function QuizNormal() {  const [mark, setMark] = useState(0)
    ...
    <>
     {
            ...
            <div className='text-center py-4'>
                <button id='result_btn' style={{display:'none'}} onClick={()=>{setCheck(true)}} className=' btn btn-outline-warning text-center'>Show Results</button>
            </div>
